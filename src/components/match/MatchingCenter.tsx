        ...
        <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 z-30">
          <div className="flex flex-row w-[350px] justify-between">
            <div className="flex flex-row gap-2 items-center">
              <h3 className="text-white font-bold text-3xl drop-shadow-2xl">Daeny</h3>
              <h3 className="text-white font-bold text-3xl drop-shadow-2xl">24</h3>
            ...
            <div className="flex">
              <button
                onClick={() =>
                  setCurrentImageIndex((p) => (p > 0 ? p - 1 : 1))
                }
              ...
              <button
                onClick={() =>
                  setCurrentImageIndex((p) => (p < 1 ? p + 1 : 0))
                }
                className="w-10 h-10 grid place-items-center"
              >
