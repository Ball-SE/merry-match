        ...
        return (
          <div key={s} className="flex items-center">
            {active ? (
              ...
              <div className="flex items-center gap-2 rounded-xl border-1 border-[#A62D82] bg-white px-2 py-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gray-100 ">
                  <span className="text-xl font-bold text-[#A62D82]">{s}</span>
                </div>
                <div className="text-left">
                  <div className="mb-1 text-gray-500 font-medium">Step {s}/3</div>
                  <div className="whitespace-nowrap text-lg font-extrabold max-xs:extrabold text-[#A62D82]">{titles[s - 1]}</div>
                </div>
              </div>
            ) : (
              // Inactive step - small circle
              <div className="flex items-center gap-3 rounded-xl border-1 border-gray-300 bg-white px-4 py-4">
