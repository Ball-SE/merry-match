...
function MerryList () {
    return(
        ...
        <div className="p-4 mt-5 lg:w-300 lg:flex lg:p-0">
            <div className="flex justify-between lg:w-290 lg:absolute">
                <img src="/assets/Mental-Strong-Women.jpg" alt="person picture" 
            ...
            <div className="lg:relative left-65">
                <div className="flex gap-1 items-center mt-3 lg:relative lg:bottom-10 lg:mt-8">
                    <p className="font-bold text-[#2A2E3F] text-lg">Daeny</p>
